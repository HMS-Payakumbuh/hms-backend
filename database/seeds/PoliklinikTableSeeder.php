...
class PoliklinikTableSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('poliklinik')->insert(array(
        ...
        array('nama'=>'Poli Penyakit Dalam', 'kategori_antrian'=>'B', 'kapasitas_pelayanan'=>40, 'sisa_pelayanan'=>40, 'id_lokasi'=>6),
        array('nama'=>'IGD', 'kategori_antrian'=>'IGD', 'kapasitas_pelayanan'=>100, 'sisa_pelayanan'=>100, 'id_lokasi'=>7),
      ));
    }
}
