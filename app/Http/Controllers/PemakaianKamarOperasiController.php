...
class PemakaianKamarOperasiController extends Controller
{
    ...
    public function index()
    {
        $pemakaianKamarOperasi = PemakaianKamarOperasi
                            ...
                            ->select(DB::raw('pemakaian_kamar_operasi.id, tindakan.id as id_tindakan, pemakaian_kamar_operasi.no_kamar, pemakaian_kamar_operasi.id_transaksi, pasien.nama_pasien, daftar_tindakan.nama as nama_tindakan, pemakaian_kamar_operasi.waktu_masuk, pemakaian_kamar_operasi.waktu_keluar, pemakaian_kamar_operasi.waktu_masuk_real, pemakaian_kamar_operasi.waktu_keluar_real'))
                            ->get();
